...
sample-redis   8.0.14    Running   4m22s
```
...
Server version: 8.0.14 Redis Community Server - GPL
...
sample-redis-backup  redis-backup-8.0.14   */5 * * * *   true     26m
```
...
NAME             VERSION   STATUS         AGE
restored-redis   8.0.14    Initializing   61s
```
...
$ kubectl get my -n demo restored-redis
NAME             VERSION   STATUS    AGE
restored-redis   8.0.14    Running   34m
```
