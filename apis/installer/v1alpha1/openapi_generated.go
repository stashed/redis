...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"stash.appscode.dev/redis/apis/installer/v1alpha1.ImageRef":       schema_redis_apis_installer_v1alpha1_ImageRef(ref),
		"stash.appscode.dev/redis/apis/installer/v1alpha1.RedisBackup":    schema_redis_apis_installer_v1alpha1_RedisBackup(ref),
		"stash.appscode.dev/redis/apis/installer/v1alpha1.RedisRestore":   schema_redis_apis_installer_v1alpha1_RedisRestore(ref),
		"stash.appscode.dev/redis/apis/installer/v1alpha1.StashRedis":     schema_redis_apis_installer_v1alpha1_StashRedis(ref),
		"stash.appscode.dev/redis/apis/installer/v1alpha1.StashRedisList": schema_redis_apis_installer_v1alpha1_StashRedisList(ref),
		"stash.appscode.dev/redis/apis/installer/v1alpha1.StashRedisSpec": schema_redis_apis_installer_v1alpha1_StashRedisSpec(ref),
	}
}
...
func schema_redis_apis_installer_v1alpha1_ImageRef(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_redis_apis_installer_v1alpha1_RedisBackup(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_redis_apis_installer_v1alpha1_RedisRestore(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_redis_apis_installer_v1alpha1_StashRedis(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("stash.appscode.dev/redis/apis/installer/v1alpha1.StashRedisSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "stash.appscode.dev/redis/apis/installer/v1alpha1.StashRedisSpec"},
	}
}

func schema_redis_apis_installer_v1alpha1_StashRedisList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "StashRedisList is a list of StashRedises",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "Items is a list of StashRedis CRD objects",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("stash.appscode.dev/redis/apis/installer/v1alpha1.StashRedis"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "stash.appscode.dev/redis/apis/installer/v1alpha1.StashRedis"},
	}
}

func schema_redis_apis_installer_v1alpha1_StashRedisSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"image": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("stash.appscode.dev/redis/apis/installer/v1alpha1.ImageRef"),
						},
					},
					"backup": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("stash.appscode.dev/redis/apis/installer/v1alpha1.RedisBackup"),
						},
					},
					"restore": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("stash.appscode.dev/redis/apis/installer/v1alpha1.RedisRestore"),
						},
					},
					"waitTimeout": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"stash.appscode.dev/redis/apis/installer/v1alpha1.ImageRef", "stash.appscode.dev/redis/apis/installer/v1alpha1.RedisBackup", "stash.appscode.dev/redis/apis/installer/v1alpha1.RedisRestore"},
	}
}
