...
import (
	...
	"stash.appscode.dev/redis/apis/installer/v1alpha1"
...
func TestStashRedisDefaultValues(t *testing.T) {
	diffstring, err := compareStashRedisDefaultValues()
	if err != nil {
		t.Error(err)
	}
	if diffstring != "" {
...
func compareStashRedisDefaultValues() (string, error) {
	data, err := ioutil.ReadFile("../../../charts/stash-redis/values.yaml")
	if err != nil {
		return "", err
	}
	...
	var spec v1alpha1.StashRedisSpec
